...
'home_title' => 'REStyling - тонування авто Тернопіль, полірування авто Тернопіль, антигравійний захист авто Тернопіль, вінілова плівка Тернопіль',

'http_home_url' => 'http://restyling.te.ua/',

'charset' => 'utf-8',

'description' => 'REStyling - тонування авто Тернопіль, полірування авто Тернопіль, антигравійний захист авто Тернопіль, вінілова плівка Тернопіль',

'keywords' => 'полірування, тонування авто, поклейка захисної плівки, захисна плівка, антигравійний захист,',

'short_title' => 'REStyling - ведуться технічні роботи!',
...
'admin_mail' => 'legranchio@mail.com.ua',
